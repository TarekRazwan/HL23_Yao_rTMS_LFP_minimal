...
#define shift2 _p[2]
#define shift2_columnindex 2
#define shift3 _p[3]
#define shift3_columnindex 3
#define shift4 _p[4]
#define shift4_columnindex 4
#define shift5 _p[5]
#define shift5_columnindex 5
#define shift6 _p[6]
#define shift6_columnindex 6
#define ihcn _p[7]
#define ihcn_columnindex 7
#define g _p[8]
...
#define mAlpha _p[12]
#define mAlpha_columnindex 12
#define mBeta _p[13]
#define mBeta_columnindex 13
#define Dm _p[14]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ih /Users/tarek/Desktop/Yao_NetPyNE_100/mod/Ih.mod\n");
...
static int  rates ( _threadargsproto_ ) {
   ...
   mAlpha = 0.001 * ( shift5 ) * ( v + shift1 ) / ( exp ( ( v + shift1 ) / ( shift2 ) ) - 1.0 ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/tarek/Desktop/Yao_NetPyNE_100/mod/Ih.mod";
static const char* nmodl_file_text = 
  ":Comment :\n"
